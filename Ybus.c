...
void Ybus(double **linedat,double **TFdata,double **Shuntdat,int nlines,int ntf,int nsh,int nbus)
{
 int i,j;

int nrows=nbus;//nlines+ntf;
...
void Ybus_linefault(double **linedat,double **TFdata,double **Shuntdat,int nlines,int ntf,int nsh,int nbus,int nbus1,int nbus2,double alpha,double time,double start_time,double clear_time)
{
 int i,j;
